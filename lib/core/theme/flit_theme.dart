...
abstract final class FlitTheme {
  static ThemeData get dark => ThemeData(
        ...
        textTheme: const TextTheme(
          ...
          bodyLarge: TextStyle(fontSize: 16, color: FlitColors.textSecondary),
          bodyMedium: TextStyle(fontSize: 14, color: FlitColors.textSecondary),
        ...
        iconTheme: const IconThemeData(color: FlitColors.textSecondary),
      );
}
