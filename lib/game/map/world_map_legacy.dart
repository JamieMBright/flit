...
/// Legacy Canvas-based globe renderer (renamed from WorldMap).
///
...
///
/// This class is retained as a fallback for platforms where the GPU
/// fragment shader pipeline is not yet available.
class WorldMapLegacy extends Component with HasGameRef<FlitGame> {
  WorldMapLegacy({this.onCountryTapped});
