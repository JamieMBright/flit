  ...
  static Map<String, dynamic> _getCountryStats(String code) {
    const allStats = <String, Map<String, String>>{
      ...
      'MG': {
        ...
        'celebrity': 'Jean-Joseph Rabearivelo',
      },
      ...
      'AE': {
        ...
        'religion': 'Islam',
        'headOfState': 'President (Federation)',
        'sport': 'Football (Soccer)',
        'language': 'Arabic',
        'celebrity': 'Hazzaa AlMansoori',
      },
      'IR': {
        'population': '87M',
        'continent': 'Asia',
