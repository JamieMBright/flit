  ...
  void paint(Canvas canvas, Size size) {
    ...
    final spacePaint = Paint()
      ..shader = RadialGradient(
        colors: [
          FlitColors.ocean.withOpacity(0.4),
          FlitColors.space,
        ],
...
class _GlobeIllustrationPainter extends CustomPainter {
  ...
  void paint(Canvas canvas, Size size) {
    ...
    final landHighPaint = Paint()..color = FlitColors.landMassHighlight.withOpacity(0.5);

    // Americas
    _drawLandBlob(canvas, center + Offset(-radius * 0.45, -radius * 0.1),
        18, 28, landPaint);
    _drawLandBlob(canvas, center + Offset(-radius * 0.5, radius * 0.35),
        12, 18, landPaint);
    // Europe/Africa
    _drawLandBlob(canvas, center + Offset(radius * 0.05, -radius * 0.2),
        14, 20, landPaint);
    _drawLandBlob(canvas, center + Offset(radius * 0.08, radius * 0.2),
        13, 24, landPaint);
    // Asia
    _drawLandBlob(canvas, center + Offset(radius * 0.35, -radius * 0.25),
        26, 18, landPaint);
    // Australia
    _drawLandBlob(canvas, center + Offset(radius * 0.42, radius * 0.38),
        14, 10, landHighPaint);
  ...
  void _drawLandBlob(Canvas canvas, Offset center, double w, double h, Paint paint) {
    canvas.drawOval(
      Rect.fromCenter(center: center, width: w.toDouble(), height: h.toDouble()),
      paint,
    );
  }
      ...
      children: [
        ...
        Expanded(
          child: ClipRRect(
            ...
            child: Stack(
              children: [
                Container(height: 8, color: FlitColors.cardBorder.withOpacity(0.4)),
...
class _ControlsDiagramPainter extends CustomPainter {
  ...
  void paint(Canvas canvas, Size size) {
    ...
    _drawGestureCircle(canvas, Offset(zone1cx, cy - 8), 18, FlitColors.oceanHighlight);
    // Arrow right
    ...
    canvas.drawCircle(Offset(zone3cx, cy - 8), 34,
    ...
    final divPaint = Paint()
      ...
      ..strokeWidth = 0.5;
    canvas.drawLine(Offset(third, 12), Offset(third, size.height - 12), divPaint);
    canvas.drawLine(
        Offset(third * 2, 12), Offset(third * 2, size.height - 12), divPaint);
  }
